...
public class TheaterScrappingSchedulerController extends Controller {
    ...
    @Inject
    public TheaterScrappingSchedulerController(ActorSystem actorSystem, SiteBuilder siteBuilder) {
    ...
    public Result startActor() {
        try {
            ...
            this.theaterScrappingActor = actorSystem.actorOf(Props.create(ACTOR_CLASS));
